...
function color_hex_to_rgb($couleur_id)
{
    ...
    $tab_rgb = array('red'   => hexdec($rouge),
                     'green' => hexdec($vert),
                     'blue'  => hexdec($bleu));
    return $tab_rgb;
}
 ...
 *  @return string HTML valid color input value ('#xxx'), 0 as default (black)
 */
function color_convert_to_html_input($color)
{
    ...
    return '#' . color_rgb_to_hex($color_rgb['red'], $color_rgb['green'], $color_rgb['blue']);
}
