...
?>
    ...
    <form method="POST" action="index.php" onSubmit="return check_password(this);">
        <fieldset>
            <p class="legend"><?php echo($lang['PROFILE_TITLE']); ?></p>
            ...
            <div>
                ...
                <input name="old_password" id="old_password" type="password" autocomplete="off" size="20"
                       maxlength="64">
            </div>

            <div>
                <label for="new_password"><?php echo $lang['PROFILE_NEWPWD'] . help("profile_password"); ?></label>
                <input name="new_password" id="new_password" type="password" autocomplete="off" size="20"
                       maxlength="64">
            </div>

            <div>
                <label for="new_password2"><?php echo $lang['PROFILE_NEWPWDAGAIN'] . help("profile_login"); ?></label>
                <input name="new_password2" id="new_password2" type="password" autocomplete="off" size="20"
                       maxlength="64">
            </div>
            ...
            <div>
                ...
                <input name="pseudo_user_token" id="pseudo_user_token" type="text" size="32" maxlength="64"
                       value="<?php echo $user_token_displayed; ?>">
            </div>
        ...
        <fieldset>
            <p class="legend"><?php echo($lang['PROFILE_GAME']); ?></p>
            <div>
        ...
        <fieldset>
            <p class="legend"><?php echo($lang['PROFILE_OFFICERS']); ?></p>
            ...
            <input name="off_technocrate" id="off_technocrate" value="1"
                   type="checkbox" <?php echo $off_technocrate; ?> />
                        </div>
        </fieldset>
        <fieldset>
            <p class="legend"><?php echo($lang['PROFILE_OTHERS']); ?></p>

            <div>
            <label for="disable_ip_check"><?php echo $lang['PROFILE_IPCHECK_DISABLE'] . help("profile_disable_ip_check"); ?></label>
            <input name="disable_ip_check" id="disable_ip_check" value="1"
                   type="checkbox" <?php echo $disable_ip_check; ?> />
            </div>
