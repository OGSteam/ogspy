                    ...
                    <tr class="<?php echo $classishided . " " . $classisallied . " " . $empytag; ?>">
                        ...
                        <td class="tdcontent"> <!-- RC -->
                            <?php if (isset($v["report_rc"]) && $v["report_rc"] > 0) : ?>
                                <a href='#' onClick="window.open('index.php?action=show_reportrc&amp;galaxy=$galaxy&amp;system=$system&amp;row=<?php echo $i; ?>','_blank','width=640, height=480, toolbar=0, location=0, directories=0, status=0, scrollbars=1, resizable=1, copyhistory=0, menuBar=0');return(false)">
