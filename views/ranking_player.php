...
switch ($order_by) {
    case "general":
        $link_general = str_replace("Général", "<img src='images/asc.png'>&nbsp;Général&nbsp;<img src='images/asc.png'>", $link_general);
        break;
    case "eco":
        $link_eco = str_replace("Economique", "<img src='images/asc.png'>&nbsp;Economique&nbsp;<img src='images/asc.png'>", $link_eco);
        break;
    case "techno":
        $link_techno = str_replace("Recherche", "<img src='images/asc.png'>&nbsp;Recherche&nbsp;<img src='images/asc.png'>", $link_techno);
        break;
    case "military":
        $link_military = str_replace("Militaire", "<img src='images/asc.png'>&nbsp;Militaire&nbsp;<img src='images/asc.png'>", $link_military);
        break;
    case "military_b":
        $link_military_b = str_replace("Mil. construit", "<img src='images/asc.png'>&nbsp;Mil.&nbsp;construit&nbsp;<img src='images/asc.png'>", $link_military_b);
        break;
    case "military_l":
        $link_military_l = str_replace("Mil. perdu", "<img src='images/asc.png'>&nbsp;Mil.&nbsp;perdu&nbsp;<img src='images/asc.png'>", $link_military_l);
        break;
    case "military_d":
        $link_military_d = str_replace("Mil. détruit", "<img src='images/asc.png'>&nbsp;Mil.&nbsp;détruit&nbsp;<img src='images/asc.png'>", $link_military_d);
        break;
    case "honnor":
        $link_honnor = str_replace("Mil. honneur", "<img src='images/asc.png'>&nbsp;Mil.&nbsp;honneur&nbsp;<img src='images/asc.png'>", $link_honnor);
        break;
}
?>
...
<table>
    <tr>
        ...
        <?php if ($user_data["user_admin"] == 1 || $user_data["user_coadmin"] == 1 || $user_data["management_ranking"] == 1) { ?>
            <form method="POST" action="index.php"
                  onsubmit="return confirm('Etes-vous sûr de vouloir supprimer ce classement ?');">
                ...
                <td align="right"><input type="image" src="images/drop.png"
                                         title="Supprimer le classement du <?php echo $date_selected; ?>"></td>
            </form>
        <?php }?>
    </tr>
</table>
