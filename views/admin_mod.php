...
<table align="center">
    ...
    <tr>
        <td class="c" colspan="6" width="550">Mods installés actifs</td>
    </tr>
    <tr>
        <td>Mods Normaux</td>
        <td colspan="4"></td>
    ...
    <tr>
        <td class="c" colspan="6" width="550">Mods installés inactifs</td>
    </tr>
    <?php
    ...
    <tr>
        <td class="c" colspan="6" width="550">Mods non installés</td>
    </tr>
    <?php
    ...
    <tr>
        <td class="c" colspan="6" width="550">Mods invalides</td>
    </tr>
    <?php
    $mods = $mod_list["wrong"];
    while ($mod = current($mods)) {
