...
<table>
    <tr>
        ...
        <td class="c" style="width:20px">
            <a href="index.php?action=home&amp;subaction=spy&amp;sort=4&amp;sort2=<?php echo $sort2; ?>"><?php echo($lang['HOME_SPY_MOON']); ?></a></td>
        <td class="c" style="width:20px">&nbsp;</td>
        <td class="c" style="width:250px">
            <a href="index.php?action=home&amp;subaction=spy&amp;sort=5&amp;sort2=<?php echo $sort2; ?>"><?php echo($lang['HOME_SPY_UPDATE']); ?></a></td>
