...
$datatable = new Datatable_js($idHtmlTable);
...
<?php if ($is_player) : ?>
    <a class="datatable-toggle-vis"
       data-column="2"<?php echo $lang['RANK_ALLY'] ?>></a> |
    <a class="datatable-toggle-vis"
       data-column="3|4"><?php echo $lang['RANK_GENERAL'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="5|6"><?php echo $lang['RANK_ECONOMY'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="7|8"><?php echo $lang['RANK_RESEARCH'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="9|10"><?php echo $lang['RANK_MILITARY'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="11|12"><?php echo $lang['RANK_MILITARY_BUILT'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="13|14"><?php echo $lang['RANK_MILITARY_LOST'] ?></a> |
    <a class="datatable-toggle-vis"
...
<?php else {
    ...
    <a class="datatable-toggle-vis"
       data-column="3|4|5"><?php echo $lang['RANK_GENERAL'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="6|7|8"><?php echo $lang['RANK_ECONOMY'] ?> </a> |
    <a class="datatable-toggle-vis"
       data-column="9|10|11"><?php echo $lang['RANK_RESEARCH'] ?> </a> |
    <a class="datatable-toggle-vis"
       data-column="12|13|14"><?php echo $lang['RANK_MILITARY'] ?></a> |
    <a class="datatable-toggle-vis"
       data-column="15|16|17"><?php echo $lang['RANK_MILITARY_BUILT'] ?> </a> |
    <a class="datatable-toggle-vis"
       data-column="18|19|20"><?php echo $lang['RANK_MILITARY_LOST'] ?> </a> |
    <a class="datatable-toggle-vis"
       data-column="20|21|22"><?php echo $lang['RANK_MILITARY_DESTROYED'] ?> </a> |
    <a class="datatable-toggle-vis"
...
?>
        ...
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_GENERAL'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_ECONOMY'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_RESEARCH'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_MILITARY'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_MILITARY_BUILT'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_MILITARY_LOST'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_MILITARY_DESTROYED'] ?></th>
        <th colspan="<?php echo $colspan; ?>"
            class="c"><?php echo $lang['RANK_MILITARY_HONOR'] ?></th>
    </tr>
    <tr>
        <?php for ($i = 0; $i < 8; $i++) : ?>
            <th class="c">Rank</th>
