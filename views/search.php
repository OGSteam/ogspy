...
@$string_search = $Ogspy->Params->string_search;
@$type_search = $Ogspy->Params->type_search;
@$strict = $Ogspy->Params->strict;
@$sort = $Ogspy->Params->sort;
@$sort2 = $Ogspy->Params->sort2;
@$galaxy_down = $Ogspy->Params->galaxy_down;
@$galaxy_up = $Ogspy->Params->galaxy_up;
@$system_down = $Ogspy->Params->system_down;
@$system_up = $Ogspy->Params->system_up;
@$row_down = $Ogspy->Params->row_down;
@$row_up = $Ogspy->Params->row_up;
@$row_active = $Ogspy->Params->row_active;
@$page = $Ogspy->Params->page;
