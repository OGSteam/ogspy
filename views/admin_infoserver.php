...
<table width="100%">
    <tr>
        <td class="c_stats" width="25%">Statistiques</td>
        <td class="c" width="25%">Valeur</td>
        <td class="c_stats" width="25%">Statistiques</td>
        <td class="c" width="25%">Valeur</td>
    </tr>
    <tr>
        <th><a>Nombre de membres</a></th>
        <th><?php echo $users_info; ?></th>
        <th><a>Nombre de planètes répertoriées libres</a></th>
        <th><?php echo
            formate_number($galaxy_statistic["nb_planets_free"]); ?></th>
    </tr>
    <tr>
        <th><a>Nombre de planètes répertoriées</a></th>
        <th><?php echo formate_number($galaxy_statistic["nb_planets"]); ?></th>
        <th rowspan="2"><a>Espace occupé par la base de données</a></th>
        <th><?php echo
            $db_size_info; ?></th>
    </tr>
    <tr>
        <th><a>Espace occupé par les logs</a></th>
        <th><?php echo $log_size_info; ?></th>
        <th><a href="index.php?action=db_optimize"><i>Optimiser la base de données</i></a></th>
    </tr>
    <tr>
        <th><a>Nombre de session ouvertes</a></th>
        <th><?php echo $connectes; ?><a href="index.php?action=drop_sessions"> (vider <?php echo
    ...
    <tr>
        ...
        <th><a>Planètes</a></th>
        <th><?php echo formate_number($planetimport_ogs); ?> importations
            - <?php echo formate_number($planetexport_ogs); ?> exportations
        </th>
    </tr>
    <tr>
        <th><a>Rapports d'espionnage</a></th>
        <th><?php echo formate_number($spyimport_ogs); ?> importations - <?php echo formate_number($spyexport_ogs); ?>
            exportations
        </th>

        <th><a>Classement (nombre de lignes)</a></th>
        <th><?php echo formate_number($rankimport_ogs); ?> importations - <?php echo formate_number($rankexport_ogs); ?>
            exportations
        </th>
    </tr>
    <tr>
...
<table width="100%">
    ...
    <tr>
        <th style="text-align:left">Merci de consulter le Forum de l'OGSteam pour connaitre la dernière version d'OGSpy:
            <a href='http://www.ogsteam.fr' target='_blank'>Forum</a></th>
    </tr>
</table>
<br/>
<table width="100%">
