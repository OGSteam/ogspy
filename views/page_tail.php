    ...
    <table style="width:100%">
        ...
        <tr>
            <td style="width:33%;text-align:left;font-size:11px;font-style:italic">
                <a style="font-weight:bold;" href="http://www.ogsteam.fr" target="_blank">OGSpy</a> <?php echo $server_config["version"];?> est un <span style="font-weight:bold;">OGSteam Software</span> &copy; 2005-2015<br />
            </td>
             ...
             <td style="width:33%;text-align:right;font-size:11px;font-style:italic">
				Temps de génération <?php echo round($php_timing+$sql_timing, 3);?> sec (<span style="font-weight:bold;">PHP</span> : <?php echo round($php_timing, 3);?> / <span style="font-weight:bold;">SQL</span> : <?php echo round($sql_timing, 3);?>) [<?php echo $nb_requete;?> requête<?php echo(($nb_requete>1) ? "s":""); ?>]
            </td>
        </tr>
    </table>
