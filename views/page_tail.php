    ...
    <table style="width:100%">
        ...
        <tr>
            <td style="width:33%;text-align:left;font-size:11px;font-style:italic">
                <a style="font-weight:bold;font-size: 12px" href="https://www.ogsteam.eu" target="_blank" rel="noopener">OGSpy</a> <?php echo $server_config["version"] . " " . $lang['FOOTER_OGSPY']; ?> OGSteam &copy; 2005-2020<br />
            </td>
