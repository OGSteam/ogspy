...
?>
            ...
            <tr>
                <th style="width:50%">
                    <input type="radio" name="typesearch" value="P" <?php if ($typesearch == 'P') { echo 'checked'; } ?>> <?php echo($lang['GALAXY_OLD_DISPLAYPLANETS']); ?>
                </th>
                <th style="width:50%">
                    <input type="radio" name="typesearch" value="M" <?php if ($typesearch == 'M') { echo 'checked'; } ?>> <?php echo($lang['GALAXY_OLD_DISPLAYMOONS']); ?>
                </th>
            </tr>
            <tr>
                <th colspan="2">
                    <input type="submit" value="<?php echo($lang['GALAXY_OLD_SEARCH']); ?>">
                </th>
            </tr>
        </table>
    </form>
...
?>
    <table>
        ...
        <tr>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_SOLAR_SYSTEM']); ?></td>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_LAST_UPDATE']); ?></td>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_SOLAR_SYSTEM']); ?></td>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_LAST_UPDATE']); ?></td>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_SOLAR_SYSTEM']); ?></td>
            <td class="c" style="width:110px"><?php echo($lang['GALAXY_OLD_LAST_UPDATE']); ?></td>
...
<?php
        if (isset($obsolete_listing[56])) {
            ...
            foreach ($obsolete as $value) {
                ...
                $i++;
                if ($index == 50) {
                    echo '<th colspan="4"><span style="color:orange; font-style:italic;">' . $lang['GALAXY_OLD_LIMITED_50SYSTEMS'] . "</span></th>\n";
                    $i = 4;
                    break;
                }
            }
