...
<table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td>
            <div><a href="index.php" class="menu"><img src="./assets/default_skin/transpa.gif" width="166" height="65" border="0"/></a></div>
        </td>
    </tr>
...
<tr>
    <td><div style="text-align='left';">
        ...
        <ul style="width:100px;" class= "menu" id="menu">
            ...
            <img src="./assets/default_skin/transpa.gif" width="166" height="19">
...
<?php
            ...
            if ($user_data["user_admin"] == 1 || $user_data["user_coadmin"] == 1) {
                ...
                if ($db->sql_numrows($result)) {
                    echo '<img src="./assets/default_skin/transpa.gif" width="166" height="19">';
