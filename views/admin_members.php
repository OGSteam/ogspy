...
<table width="200">
    ...
    <tr>
        <th width="100"><input type="button" value="Créer nouveau membre"
...
<div id="new_pass" name="new_pass"
     style="visibility:hidden;position: fixed;    top: 300px;     left: 500;z-index: 100;">
    <table width="200" style="border:1px #003399 solid;" cellpadding="3">
        <tr>
            <td align="center" class="c">Nouveau mot de passe</td>
        </tr>
        <tr>
            <th align="center">
