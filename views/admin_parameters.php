...
<form method="POST" action="index.php">
    ...
    <table width="100%">
        ...
        <tr>
            <th>Durée des sessions <a>[5-180 minutes]</a> <a>[0=durée
                    indéterminée&nbsp;<?php echo help("admin_session_infini");?>]</a></th>
        ...
        <tr>
            <th width="60%">Liste des alliances à ne pas afficher<br/>

                <div class="z"><i>Séparez les alliances avec des virgules</i></div>
            </th>
            <th><input type="text" size="60" name="ally_protection" value="<?php echo $ally_protection; ?>"></th>
        </tr>
        <tr>
            <th width="60%">Liste des alliances amies<br/>
        ...
        <tr>
            <th>Journaliser les transactions et requêtes SQL&nbsp;<?php echo help("admin_save_transaction");?><br/>

                <div class="z"><i>Risque de dégradation des performances du serveur</i></div>
            </th>
        ...
        <tr>
            ...
            <th><input type="text" name="max_keeprank" maxlength="4" size="5" value="<?php echo $max_keeprank; ?>">&nbsp;<select
                    ...
                    <option value="quantity" <?php echo $keeprank_criterion == "quantity" ? "selected" : "";?>>Nombre
                    </option>
                    <option value="day" <?php echo $keeprank_criterion == "day" ? "selected" : "";?>>Jours</option>
                </select></th>
        </tr>
        <tr>
    ...
    ?>
        ...
        <tr>
            ...
            <th><input name="num_of_galaxies" id="galaxies" type="text" size="5" maxlength="3"
                       ...
                       onChange="if (!confirm('Etes vous sur de vouloir modifier le nombre de galaxies?\nsi vous réduisez ce nombre\nLes membres qui sont définit comme étant dans l\'une des galaxies supprimé ce verront mis dans la galaxie 1, système 1\n et leur favoris supprimé')){document.getElementById('galaxies').value='<?php echo $num_of_galaxies; ?>';}"
                       readonly="readonly"> &nbsp; &nbsp; active le champs(<input name="enable_input_num_galaxies"
                                                                                  type="checkbox"
        ...
        <tr>
            ...
            <th><input name="num_of_systems" id="systems" type="text" size="5" maxlength="3"
                       ...
                       onChange="if (!confirm('Etes vous sur de vouloir modifier le nombre de systèmes?\nsi vous réduisez ce nombre\nLes membres qui sont définit comme étant dans l\'un des systèmes supprimé ce verront mis dans la galaxie 1, système 1\n et leur favoris supprimé')){document.getElementById('systems').value='<?php echo $num_of_systems; ?>';}"
                       readonly="readonly"> &nbsp; &nbsp; active le champs(<input name="enable_input_num_systems"
                                                                                  type="checkbox"
        ...
        <tr>
            ...
            <th><input name="speed_uni" id="speed_uni" type="text" size="5" maxlength="2"
                       ...
                       onChange="if (!confirm('Etes vous sur de vouloir modifier la vitesse du jeu?\n')){document.getElementById('speed_uni').value='<?php echo $speed_uni; ?>';}"
                       readonly="readonly"> &nbsp; &nbsp; active le champs(<input name="enable_input_speed_uni"
                                                                                  type="checkbox"
        ...
        <tr>
            ...
            <th>Galaxies arrondies<input name="uni_arrondi_galaxy" value="1"
                                         type="checkbox"<?php print ($uni_arrondi_galaxy == 1) ? ' checked' : '' ?>>&nbsp;&nbsp;Systèmes
                arrondis<input name="uni_arrondi_system" value="1"
                               type="checkbox"<?php print ($uni_arrondi_system == 1) ? ' checked' : '' ?>></th>
        </tr>
        <tr>
            <?php
            }
        ...
        <tr>
            <th width="60%">Durée de conservation du cache "config" <?php echo help("config_cache");?> <br/>

                <div class="z"><i>(Attention, peut impacter la mise a jour des statitistiques du serveur et le ratio ..
                        )</i></div>
            </th>
        ...
        <tr>
            <th>Enregistrement des erreurs php<br/>

                <div class="z"><i>(Surveillez vos journaux.. peut prendre beaucoup de place)</i></div>
            </th>
        ...
        if ($user_data["user_admin"] == 1) {
            ?>
            <tr>
                <td class="c_ogame" colspan="2">Utilisateurs Google Cloud Messaging
                    <div class="z"><i>Necessaire pour les push de noticications sur les appareils android</i></div>
                </td>
            </tr>
            <tr>
