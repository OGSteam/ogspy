    ...
    <form method="POST" action="index.php" name="view">
        ...
        <fieldset>
            ...
            <select name="open_user" id="open_user" >
                ...
                <?php $selected = ($open_user == "./views/profile.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/profile.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_PROFILE']; ?> </option>

                <?php $selected = ($open_user == "./views/home.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/home.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_ACCOUNT']; ?> </option>

                <?php $selected = ($open_user == "./views/galaxy.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/galaxy.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_GALAXY']; ?> </option>

                <?php $selected = ($open_user == "./views/cartography.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/cartography.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_ALLY']; ?> </option>

                <?php $selected = ($open_user == "./views/search.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/search.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_SEARCH']; ?> </option>

                <?php $selected = ($open_user == "./views/ranking.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/ranking.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_RANKINGS']; ?> </option>

                <?php $selected = ($open_user == "./views/statistic.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/statistic.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_STATS']; ?> </option>

                <?php $selected = ($open_user == "./views/galaxy_obsolete.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/galaxy_obsolete.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_TOBEUPDATED']; ?> </option>
            ...
            <select name="open_admin"  id="open_admin" >
                ...
                <?php $selected = ($open_admin == "./views/admin.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/admin.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_ADMIN']; ?> </option>

                <?php $selected = ($open_admin == "./views/profile.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/profile.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_PROFILE']; ?> </option>

                <?php $selected = ($open_admin == "./views/home.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/home.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_ACCOUNT']; ?> </option>

                <?php $selected = ($open_admin == "./views/galaxy.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/galaxy.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_GALAXY']; ?> </option>

                <?php $selected = ($open_admin == "./views/cartography.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/cartography.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_ALLY']; ?> </option>

                <?php $selected = ($open_admin == "./views/search.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/search.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_SEARCH']; ?> </option>

                <?php $selected = ($open_admin == "./views/ranking.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/ranking.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_RANKINGS']; ?> </option>

                <?php $selected = ($open_admin == "./views/statistic.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/statistic.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_STATS']; ?> </option>

                <?php $selected = ($open_admin == "./views/galaxy_obsolete.php")  ? ' selected '  : ' '; ?>
                <option <?php echo $selected ; ?> value="./views/galaxy_obsolete.php"> <?php echo $lang['ADMIN_DISPLAY_LOGIN_MODULE_TOBEUPDATED']; ?> </option>
