...
<tr>
	<th width="60%">Affichage des stats des membres&nbsp;<?php echo help(null,"Affiche ou cache le tableau de statistique des membres en bas de la page statistiques");?></th>
...
<tr>
	<th width="60%">Affichage du panneau inscription&nbsp;<?php echo help(null,"Affiche ou cache le tableau contenan le lien du forum de cet OGSpy");?></th>
	<th><input name="enable_register_view" type="checkbox" value="1" <?php echo $enable_register_view;?> onClick="if (view.enable_register_view.checked == false)view.enable_members_view.checked=false;"></th>
</tr>
<tr>
...
<tr>
	<th width="60%">Lien du forum d'inscription&nbsp;<?php echo help(null,"Lien d'une section du forum, voir le PM de l'administrateur OGSpy");?></th>
