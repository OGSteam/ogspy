...
$link_general = "<a href='index.php?action=ranking&amp;view=ally&amp;order_by=general'>" . $lang['RANK_GENERAL'] . "</a>";
$link_eco = "<a href='index.php?action=ranking&amp;view=ally&amp;order_by=eco'>" . $lang['RANK_ECONOMY'] . "</a>";
$link_techno = "<a href='index.php?action=ranking&amp;view=ally&amp;order_by=techno'>" . $lang['RANK_RESEARCH'] . "</a>";
$link_military = "<a href='index.php?action=ranking&amp;view=ally&amp;order_by=military'>" . $lang['RANK_MILITARY'] . "</a>";
        ...
        <tr>
            <th>
                <form method="POST" action="index.php">
                    ...
                    <input type="hidden" name="view" value="ally">
            ...
            <?php if ($user_data["admin"] == 1 || $user_data["coadmin"] == 1 || $user_data["management_ranking"] == 1) { ?>
                <th>
                    <form method="POST" action="index.php" onsubmit="return confirm('<?php echo ($lang['RANK_DELETE_CONFIRMATION']); ?>');">
                        ...
                        <input class="og-button og-button-image  og-button-danger" type="image" src="images/drop.png" title="<?php echo $lang['RANK_DELETE'] . " " . $date_selected; ?>">
                    </form>
                </th>
    ...
    <tbody>
        <?php while ($value = current($order)) : ?>
            ...
            if (isset($ranking[$value]["general"]["points"])) {
                ...
                $general_pts_per_member = formate_number($ranking[$value]["general"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["eco"]["points"])) {
                ...
                $eco_pts_per_member = formate_number($ranking[$value]["eco"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["techno"]["points"])) {
                ...
                $techno_pts_per_member = formate_number($ranking[$value]["techno"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["military"]["points"])) {
                ...
                $military_pts_per_member = formate_number($ranking[$value]["military"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["military_b"]["points"])) {
                ...
                $military_b_pts_per_member = formate_number($ranking[$value]["military_b"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["military_l"]["points"])) {
                ...
                $military_l_pts_per_member = formate_number($ranking[$value]["military_l"]["points"] / $ranking[$value]["number_member"]);
            ...
            if (isset($ranking[$value]["military_d"]["points"])) {
                ...
                $military_d_pts_per_member = formate_number($ranking[$value]["military_d"]["points"] / $ranking[$value]["number_member"]);
            ...
            <tr>
                ...
                <td>
                    <a href='index.php?action=search&amp;type_search=ally&amp;string_search=<?php echo $value; ?>&amp;strict=on'>
                        <?php echo $value; ?>
                    </a>
                </td>
                <td>
                    <?php echo formate_number($ranking[$value]["number_member"]); ?>
                </td>
                <td class="<?php echo $general_active_link;?>">
                    <?php echo $general_pts; ?><br>(<span class="og-highlight"><?php echo $general_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $eco_active_link;?>">
                    <?php echo $eco_pts; ?><br>(<span class="og-highlight"><?php echo $eco_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $techno_active_link;?>">
                    <?php echo $techno_pts; ?><br>(<span class="og-highlight"><?php echo $techno_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $military_active_link;?>">
                    <?php echo $military_pts; ?><br>(<span class="og-highlight"><?php echo $military_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $military_b_active_link;?>">
                    <?php echo $military_b_pts; ?><br>(<span class="og-highlight"><?php echo $military_b_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $military_l_active_link;?>">
                    <?php echo $military_l_pts; ?><br>(<span class="og-highlight"><?php echo $military_l_pts_per_member; ?></span>)
                </td>
                ...
                <td class="<?php echo $military_d_active_link;?>">
                    <?php echo $military_d_pts; ?><br>(<span class="og-highlight"><?php echo $military_d_pts_per_member; ?></span>)
                </td>
