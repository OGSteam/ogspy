...
switch ($order_by) {
    case "general":
        $link_general = str_replace($lang['RANK_GENERAL'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_GENERAL']."&nbsp;<img src='assets/images/asc.png'>", $link_general);
        break;
    case "eco":
        $link_eco = str_replace($lang['RANK_ECONOMY'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_ECONOMY']."&nbsp;<img src='assets/images/asc.png'>", $link_eco);
        break;
    case "techno":
        $link_techno = str_replace($lang['RANK_RESEARCH'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_RESEARCH']."&nbsp;<img src='assets/images/asc.png'>", $link_techno);
        break;
    case "military":
        $link_military = str_replace($lang['RANK_MILITARY'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_MILITARY']."&nbsp;<img src='assets/images/asc.png'>", $link_military);
        break;
    case "military_b":
        $link_military_b = str_replace($lang['RANK_MILITARY_BUILT'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_MILITARY_BUILT']."&nbsp;<img src='assets/images/asc.png'>", $link_military_b);
        break;
    case "military_l":
        $link_military_l = str_replace($lang['RANK_MILITARY_LOST'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_MILITARY_LOST']."&nbsp;<img src='assets/images/asc.png'>", $link_military_l);
        break;
    case "military_d":
        $link_military_d = str_replace($lang['RANK_MILITARY_DESTROYED'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_MILITARY_DESTROYED']."&nbsp;<img src='assets/images/asc.png'>", $link_military_d);
        break;
    case "honnor":
        $link_honnor = str_replace($lang['RANK_MILITARY_HONOR'], "<img src='assets/images/asc.png'>&nbsp;".$lang['RANK_MILITARY_HONOR']."&nbsp;<img src='assets/images/asc.png'>", $link_honnor);
        break;
}
?>
    ...
    <tr>
        ...
        <?php if ($user_data["user_admin"] == 1 || $user_data["user_coadmin"] == 1 || $user_data["management_ranking"] == 1) { ?>
            <form method="POST" action="index.php"
                ...
                <td align="right"><input type="image" src="assets/images/drop.png" title="<?php echo $lang['RANK_DELETE']." ".$date_selected; ?>"></td>
            </form>
        <?php }?>
    </tr>
</table>
