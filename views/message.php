...
switch ($pub_id_message) {
	...
	$message .= "<font color='red'><b>La configuration des paramètres d'affichage à échouée</b></font>";
	$action = "action=administration&subaction=affichage";
	break;
	...
	//
	case "log_remove" :
	$message .= "<font color='lime'><b>Le fichier log séléctionné a bien été supprimé</b></font>";
	$action = "action=administration&subaction=viewer";
	break;
