...
<form style="margin-bottom:40px;" method='post' action=''>
	...
	<table style="margin:0 auto; padding:0; border-collapse:separate; border-spacing:1px">
		...
		<tr>
			<th colspan='2'>Si vous ne disposez pas d'un compte, il faut <span style="color:red">obligatoirement</span> en demander un sur le forum de <?php echo $server_config['register_alliance']; ?>.</th>
		</tr>
		<tr>
			<th colspan='2'><input type="button" value="Demander un compte" onclick="window.open('<?php echo $server_config['register_forum']; ?>');" /></th>
		</tr>
		<?php
