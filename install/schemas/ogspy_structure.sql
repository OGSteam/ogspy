...
(
    `id`              INT(11)     NOT NULL AUTO_INCREMENT,
    `player_id`       INT(11)     NOT NULL DEFAULT '0' COMMENT 'ID du joueur du jeu, remplace user_id',
    ...
    UNIQUE KEY `uniq_player_planet` (`player_id`, `planet_id`),
    UNIQUE KEY `uniq_player_moon` (`player_id`, `moon_id`),
    PRIMARY KEY (`id`)
)
    DEFAULT CHARSET = UTF8;
