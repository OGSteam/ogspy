...
$lang["help_admin_check_ip"] = "Some users are sometimes disconnected (AOL, Proxy, etc).<br>Enable this setting to allow them to not be disconnected anymore.";
...
$lang["help_profile_password"] = "Must contain between 6 and 15 characters (special characters are not accepted)";
...
$lang['help_member_connected'] = "Displays (*) in order to know if the user is connected <br>Disabled if the member list display is not active";
