...
$help["admin_check_ip"] = "Some users are sometimes disconnected (AOL, Proxy, etc).<br>Enable this setting to allow them to not be disconnected anymore.";
...
$help["search_strict"] = "<font color=orange>Searched Player :</font><br><i>Liquid snake</i><br><font color=orange>Search criteria :</font><br><i>snake</i><br><br>=> <font color=lime>Positive Result</font> if \"strict\" option is disabled<br>=> <font color=red>Negative Result</font> if strict option is enabled.";
...
$help["profile_galaxy"] = "Should contain a number between 1 and 999";
$help["profile_disable_ip_check"] = "Ip Adress verification prevents your account from a session steal.";
...
$help['member_connected'] = "Displays (*) in order to know if the user is connected <br>Disabled if the member list display is not active";
$help['member_registration'] = "Display or hide the table containing your forum url for this OGSpy";
