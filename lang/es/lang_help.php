...
$help["admin_save_transaction"] ="Las transacciones corresponden a: <br /> - Sistemas solares <br/ > - Reportes de espionaje<br /> - Ranking de jugadores y alianza";
...
$help["profile_disable_ip_check"] .="Si te desconecta de forma regular (AOL, Proxy, etc) desactiva la verificación. <br /> <br />";
$help["profile_disable_ip_check"] .="Si te desconecta de forma regular (AOL, Proxy, etc) desactiva la verificación. <br /> <br />";
